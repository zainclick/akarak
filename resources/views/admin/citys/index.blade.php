@php
    $title_page=__('admin/citys/index.title');
@endphp
...
<div class="col-12 p-3">
	...
	<x-bread-crumb :breads="[
			...
			['url' => route('admin.citys.index') , 'title' => __('admin/citys/index.title') , 'isactive' => true],
		]" >
	...
	<div class="col-12 col-lg-12 p-0 main-box">
		<div class="col-12 px-0">
			<div class="col-12 p-0 row">
				<div class="col-12 col-lg-4 py-3 px-3">
					<span class="fas fa-users"></span>	{{__('admin/citys/index.title')}}
				</div>
				<div class="col-12 col-lg-4 p-0">
				</div>
				<div class="col-12 col-lg-4 p-2 text-lg-end">
					@can('users-create')
					<a href="{{route('admin.citys.create')}}">
		...
		<div class="col-12 p-3" style="overflow:auto">
			...
			<table class="table table-bordered  table-hover">
				<thead>
					<tr>
						<th>#</th>
						<th>{{__('admin/citys/index.name')}}</th>
						<th>{{__('admin/citys/index.status')}}</th>
				...
				<tbody>
					...
					<tr>
						<td>{{$city->id}}</td>
						<td>
						<?php if(app()->getLocale() == 'ar'){echo $city->name_ar;}else{echo $city->name_en;}  ?>
						</td>
						<td>
						<?php
						 if($city->status == 0){
						...
						<td>
							@can('users-read')
							<a href="{{route('admin.citys.show',$city)}}">
							...
							@can('users-update')
							<a href="{{route('admin.citys.edit',$city)}}">
							...
							@can('users-delete')
							<form method="POST" action="{{route('admin.citys.destroy',$city)}}" class="d-inline-block">@csrf @method("DELETE")
							...
							<div class="dropdown d-inline-block">
								...
								@can('users-update')
								<li><a class="dropdown-item font-1" href="{{route('admin.citys.show',$city)}}"><span class="fal fa-eye"></span> دخول</a></li>
								@endcan
		...
		<div class="col-12 p-3">
			{{$citys->appends(request()->query())->render()}}
		</div>
	</div>
</div>
@endsection
