@php
    $title_page=__('admin/main.dashboard');
@endphp
...
<div class="col-12 col-sm-6 col-lg-4 col-xl-3 col-xxl-2 px-2 my-2">
	<div class="col-12 px-0 py-1 d-flex main-box-wedit" >
		...
		<div style="width: calc(100% - 80px)" class="px-2 py-2">
			<a class="font-1"  href="{{route('admin.agencies.index')}}" style="color: #212529">
				{{__('admin/dashboard.agencies')}}
				<h6 class="font-3">{{\App\Models\Backend\agencies::count()}}</h6>
			</a>
		</div>
	</div>
</div>
...
<div class="col-12 col-sm-6 col-lg-4 col-xl-3 col-xxl-2 px-2 my-2">
	<div class="col-12 px-0 py-1 d-flex main-box-wedit" >
		...
		<div style="width: calc(100% - 80px)" class="px-2 py-2">
			<a class="font-1"  href="{{route('admin.agencies.index')}}" style="color: #212529">
				{{__('admin/dashboard.agencies_check')}}
				<h6 class="font-3">{{\App\Models\Backend\agencies::where('status',1)->count()}}</h6>
			</a>
		</div>
	</div>
</div>
	...
	<div class="col-12 px-0 py-1 d-flex main-box-wedit" >
		...
		<div style="width: calc(100% - 80px)" class="px-2 py-2">
			<a class="font-1"  href="{{route('admin.packages.index')}}" style="color: #212529">
				{{__('admin/dashboard.users_blocked')}}
	...
	<div class="col-12 px-0 py-1 d-flex main-box-wedit" >
		...
		<div style="width: calc(100% - 80px)" class="px-2 py-2">
			<a class="font-1" href="{{route('admin.categories.index')}}" style="color: #212529;">
				{{__('admin/dashboard.agents_blocked')}}
	...
	<div class="col-12 px-0 py-1 d-flex main-box-wedit" >
		...
		<div style="width: calc(100% - 80px)" class="px-2 py-2">
			<a class="font-1"  href="" style="color: #212529">
				{{__('admin/dashboard.properties_check')}}
				<h6 class="font-3">{{\App\Models\Backend\Packages::count()}}</h6>
			</a>
		</div>
	</div>
