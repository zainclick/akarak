@php
    $title_page=__('admin/languages/index.title');
@endphp
...
<div class="col-12 p-3">
	...
	<x-bread-crumb :breads="[
			...
			['url' => route('admin.languages.index') , 'title' => __('admin/languages/index.title') , 'isactive' => true],
		]" >
	...
	<div class="col-12 col-lg-12 p-0 main-box">
		<div class="col-12 px-0">
			<div class="col-12 p-0 row">
				<div class="col-12 col-lg-4 py-3 px-3">
					<span class="fas fa-users"></span>	{{__('admin/languages/index.title')}}
				</div>
		...
		<div class="col-12 p-3" style="overflow:auto">
			...
			<table class="table table-bordered  table-hover">
				<thead>
					<tr>
						<th>#</th>
						<th>{{__('admin/languages/index.name')}}</th>
						<th>{{__('admin/languages/index.status')}}</th>
				...
				<tbody>
					...
					<tr>
						<td>{{$language->id}}</td>
						<td>
						<?php if(app()->getLocale() == 'ar'){echo $language->name_ar;}else{echo $language->name_en;}  ?>
						</td>
						<td>
						<?php
						...
						<td>
							@can('users-read')
							<a href="{{route('admin.citys.show',$language)}}">
							...
							@can('users-delete')
							<form method="POST" action="{{route('admin.languages.destroy',$language)}}" class="d-inline-block">@csrf @method("DELETE")
							...
							<div class="dropdown d-inline-block">
								...
								@can('users-update')
								<li><a class="dropdown-item font-1" href="{{route('admin.citys.show',$language)}}"><span class="fal fa-eye"></span> دخول</a></li>
								@endcan
		...
		<div class="col-12 p-3">
			{{$languages->appends(request()->query())->render()}}
		</div>
	</div>
</div>
@endsection
