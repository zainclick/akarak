			<div class="search-header-banner">
				<div class="hero-search" style="text-align: center;">
					<h1 style="color: #fff !important;font-size: 30px;">{{__('front/agencies/index.search_agencies')}}</h1>
				</div>
				<div class="container">
						...
						<div class="col-lg-4 col-md-6">
							<div class="form-group">
								<div class="input-with-icon">
									<input type="text" class="form-control" required name="agency" placeholder="{{__('front/agencies/index.name_or_location')}}">
