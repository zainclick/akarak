									...
									<div class="property-listing property-1">
														...
														<div class="listing-content">
															...
															<div class="listing-footer-wrapper">
																<div style="width: 40px;height: 40px;border-radius: 50%;1px solid#7363ba;overflow: hidden;margin-right: 80px;border: 1px solid#7363ba;" class="agent-photo"><a><img style="width: 100%;height: 100%;" src="{{$property->agent_fk->main_image()}}" alt=""></a></div>
															...
															<div class="listing-contact-info">
																...
																<div class="listing-detail-btn">
																	<a style="color: #7363ba;border: 1px solid #7363ba;border-radius: 8px;font-weight: bold;background-color: #fff;" href="{{route('front-properties-show',$property->slug)}}" class="more-btn">{{__('front/properties/index.more_info')}}</a>
																</div>
															</div>
