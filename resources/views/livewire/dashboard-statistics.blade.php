        ...
        <div class="col-12 col-lg-5 p-2">
         ...
         <div class="col-12 col-lg-7 p-2">
            ...
            <div class="col-12 p-0 main-box">
                ...
                $subscription = \Laravel\Cashier\Subscription::where('agencies_id',auth('agency')->user()->id)->first();
                    if($subscription != null){

                    if($subscription->ends_at != null){?>
                        <div class="sub-expired">Your Subscripe has been Expired !</div>
                    <?php }else{ ?>
                    <div class="col-12 p-3 row d-flex" style="height: 198px;background-color: #ffffff;">
                   ...
                   <?php }
                    ...
                    <div class="sub-expired">You are Not Subscriped Any Plan !</div>
                  <?php }
                  }
                 ?>
