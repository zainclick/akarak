		...
		<div class="col-12 p-3" style="overflow:auto">
			...
			<table class="table table-bordered  table-hover">
				...
				<tbody>
					...
					<tr>
						<td>{{$property->property_fk->id}}</td>
						<td>
						<?php if(app()->getLocale() == 'ar'){echo $property->property_fk->title_ar;}else{echo $property->property_fk->title_en;} ?>
						</td>
						<td><?php if(app()->getLocale() == 'ar'){echo $property->agency_fk->name_ar;}else{echo $property->agency_fk->name_en;} ?></td>
						<td><?php if(app()->getLocale() == 'ar'){echo $property->property_fk->agent_fk->name_ar;}else{echo $property->property_fk->agent_fk->name_en;} ?></td>
						<td>
						<?php 
						...
						<td>
							...
							<div class="dropdown d-inline-block">
								...
								<?php 
									if($property->property_fk->property_features_fk->count() > 0){ ?>
