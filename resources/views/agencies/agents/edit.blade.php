...
<div class="col-12 p-3">
	...
	<form id="validate-form" class="row" enctype="multipart/form-data" method="POST" action="{{route('agency-agents-update',$agent->slug)}}">
		@csrf
        @method('PUT')
	<div class="col-12 col-lg-7 <?php if(app()->getLocale() == 'en'){echo 'offset-md-1';} ?> p-0 ">
		...
		<div class="col-12 col-lg-12 p-0 main-box">
			...
			<div class="col-12 col-lg-6 p-2">
				...
				<div class="col-12 pt-3">
					<input type="text" name="name_ar" required minlength="3"  maxlength="190" class="form-control" value="{{old('name_ar',$agent->name_ar)}}" >
				</div>
			</div>
			...
			<div class="col-12 col-lg-6 p-2">
				...
				<div class="col-12 pt-3">
					<input type="text" name="name_en" required minlength="3"  maxlength="190" class="form-control" value="{{old('name_en',$agent->name_en)}}" >
				</div>
			</div>
				...
				<div class="col-12 pt-3">
					...
					<option>{{__('agencies/agents/create.job_title')}}</option>
						@foreach($titles as $title)
							<option <?php if($title->id == $agent->title){echo 'selected';} ?> value="{{$title->id}}"><?php if(app()->getLocale() == 'ar'){echo $title->name_ar;}else{echo $title->name_en;} ?></option>
						@endforeach
					</select>
				</div>
			</div>
				...
				<div class="col-12 pt-3">
					...
					<option>{{__('agencies/agents/create.city')}}</option>
						@foreach($citys as $city)
							<option <?php if($city->id == $agent->city){echo 'selected';} ?>  value="{{$city->id}}"><?php if(app()->getLocale() == 'ar'){echo $city->name_ar;}else{echo $city->name_en;} ?></option>
						@endforeach
					</select>
				</div>
			</div>
				...
				<div class="col-12 pt-3">
					...
					<option>{{__('agencies/agents/create.country')}}</option>
						@foreach($countries as $country)
							<option <?php if($country->id == $agent->country){echo 'selected';} ?> value="{{$country->id}}">{{$country->name}}</option>
						@endforeach
					</select>
				</div>
			</div>
			...
			<div class="col-12 col-lg-6 p-2">
				...
				<div class="col-12 pt-3">
					<input type="date" name="since" required minlength="3"  maxlength="190" class="form-control" value="{{old('since',$agent->since)}}" >
				</div>
			</div>
			...
			<div class="col-12 col-lg-6 p-2">
				...
				<div class="col-12 pt-3">
					<select class="form-control" required name="status">
						<option @if($agent->status =="0") selected @endif value="0">{{__('main.active')}}</option>
						<option @if($agent->status =="1") selected @endif value="1">{{__('main.dis_active')}}</option>
					</select>
				</div>
			</div>
			...
			<div class="col-12 col-lg-6 p-2">
				...
				<div class="col-12 pt-3">
                <textarea name="bio_ar" class="editor with-file-explorer">{{old('bio_ar',$agent->bio_ar)}}</textarea>
				</div>
			</div>
			...
			<div class="col-12 col-lg-6 p-2">
				...
				<div class="col-12 pt-3">
                <textarea name="bio_en" class="editor with-file-explorer">{{old('bio_en',$agent->bio_en)}}</textarea>
				</div>
			</div>
		...
		<div class="col-12 col-lg-12 p-0 main-box">
			...
			<div class="col-12 col-lg-12 p-2">
				...
				<div class="col-12 pt-3">
					<input type="email" name="email" required minlength="3"  maxlength="190" class="form-control" value="{{old('email',$agent->email)}}" >
				</div>
			</div>
			...
			<div class="col-12 col-lg-12 p-2">
				...
				<div class="col-12 pt-3">
					<input type="number" name="mobile" required minlength="3"  maxlength="190" class="form-control" value="{{old('mobile',$agent->mobile)}}" >
				</div>
			</div>
			...
			<div class="col-12 col-lg-12 p-2">
				...
				<div class="col-12 pt-3">
					<input type="text" name="facebook"  minlength="3"  maxlength="190" class="form-control" value="{{old('facebook',$agent->mobile)}}" >
				</div>
			</div>
			...
			<div class="col-12 col-lg-12 p-2">
				...
				<div class="col-12 pt-3">
					<input type="number" name="whatsapp"  minlength="3"  maxlength="190" class="form-control" value="{{old('whatsapp',$agent->whatsapp)}}" >
				</div>
			</div>
			...
			<div class="col-12 col-lg-12 p-2">
				...
				<div class="col-12 pt-3">
			        <textarea style="width: 100%;" name="address">{{old('address',$agent->address)}}</textarea>
				</div>
