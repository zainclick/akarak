...
<body style="background: #eef4f5" class="dash">
    ...
    <div class="col-12 d-flex">
        ...
        <div class="col-12 px-0 pb-4 text-center justify-content-center align-items-center ">
            ...
            <img src="" style="width: 80px;height: 80px;color: var(--background-1);border-radius: 50%" class="d-inline-block">
                </a>
            ...
            <div class="col-12 px-0">
                ...
                <div class="col-12 px-3 aside-menu" style="height: calc(100vh - 260px);overflow: auto;">
                    ...
                    <a href="{{route('vendor.index')}}" class="col-12 px-0" >
                    ...
                    @can('roles-read')
                    <a href="{{route('vendor.roles.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    @endcan
                    @can('users-read')
                    <a href="{{route('vendor.users.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    @foreach($plugins as $plugin)
                        @if($plugin->get('type')=="main")
                            @can($plugin->get('route').'-read')
                                <a href="{{route('vendor.'.$plugin->get('route').'.index')}}" class="col-12 px-0" >
                                    <div class="col-12 item-container px-0 d-flex " >
                                        <div style="width: 50px" class="px-3 text-center">
                        ...
                        <div class="col-12 item px-0 d-flex row " >
                            ...
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    @can('categories-read')
                                    <li><a href="{{route('vendor.categories.index')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> الأقسام</a></li>
                                    @endcan
                                    @can('articles-read')
                                    <li><a href="{{route('vendor.articles.index')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> المقالات</a></li>
                                    @endcan

                                    @can('comments-read')
                                    <li><a href="{{route('vendor.article-comments.index')}}" style="font-size: 16px;"><span class="fal fa-comments px-2" style="width: 28px;font-size: 15px;"></span> التعليقات
                                        @php
                                    ...
                                    <li><a href="{{route('vendor.announcements.index')}}" style="font-size: 16px;"><span class="fal fa-bullhorn px-2" style="width: 28px;font-size: 15px;"></span> الإعلانات
                                    </a></li>
                                    @endcan
                                    @can('pages-read')
                                    <li><a href="{{route('vendor.pages.index')}}" style="font-size: 16px;"><span class="fal fa-file-invoice px-2" style="width: 28px;font-size: 15px;"></span> الصفحات
                                    </a></li>
                                    @endcan

                                    @can('menus-read')
                                    <li><a href="{{route('vendor.menus.index')}}" style="font-size: 16px;"><span class="fal fa-list px-2" style="width: 28px;font-size: 15px;"></span> القوائم
                                    </a></li>
                                    @endcan
                                    @can('faqs-read')
                                    <li><a href="{{route('vendor.faqs.index')}}" style="font-size: 16px;"><span class="fal fa-question px-2" style="width: 28px;font-size: 15px;"></span> الأسئلة الشائعة
                                    </a></li>
                                    @endcan
                                    @can('redirections-read')
                                    <li><a href="{{route('vendor.redirections.index')}}" style="font-size: 16px;"><span class="fal fa-directions px-2" style="width: 28px;font-size: 15px;"></span> التحويلات
                                    </a></li>
                                    @endcan
                                    @can('tags-read')
                                    <li><a href="{{route('vendor.tags.index')}}" style="font-size: 16px;"><span class="fal fa-tags px-2" style="width: 28px;font-size: 15px;"></span> الوسوم
                                    </a></li>
                                    @endcan
                    ...
                    @can('contacts-read')
                    <a href="{{route('vendor.contacts.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    @can('settings-update')
                    <a href="{{route('vendor.settings.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                        ...
                        <div class="col-12 item px-0 d-flex row " >
                            ...
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    ...
                                    @can('plugins-read')
                                    <li><a href="{{route('vendor.plugins.index')}}" style="font-size: 16px;"><span class="fal fa-box-open px-2" style="width: 28px;font-size: 15px;"></span> كل الاضافات
                ...
                <div class="col-12 px-0 d-flex justify-content-end  " style="height: 60px;">
                    ...
                    <div class="btn-group" id="notificationDropdown">
                        ...
                        <div class="dropdown-menu py-0 rounded-0 border-0 shadow " style="cursor: auto!important;z-index: 20000;width: 350px;height: 450px;top: -3px!important;">
                            ...
                            <div class="col-12 d-flex border-top"> 
                                <a href="{{route('vendor.notifications.index')}}" class="d-block py-2 px-3 ">
                    ...
                    <div class="col-12 px-0 d-flex justify-content-center align-items-center  dropdown"  style="width: 55px;height: 55px;" >
                        ...
                        <ul class="dropdown-menu shadow border-0" aria-labelledby="dropdownMenuButton1" style="top: -3px;">
                                ...
                                <li><a class="dropdown-item font-1" href="{{route('vendor.profile.index')}}"><span class="fal fa-user font-1"></span> ملفي الشخصي</a></li>

                                <li><a class="dropdown-item font-1" href="{{route('vendor.profile.edit')}}"><span class="fal fa-edit font-1"></span> تعديل ملفي الشخصي</a></li> 

                                


                                @can('hub-files-read')
                                <li><a class="dropdown-item font-1" href="{{route('vendor.files.index')}}"><span class="fal fa-file font-1"></span> الملفات</a></li> 
                                @endcan


                                @can('traffics-read')
                                <li><a class="dropdown-item font-1" href="{{route('vendor.traffics.index')}}"><span class="fal fa-traffic-light font-1"></span> الترافيك</a></li> 
                                @endcan

                                @can('error-reports-read')
                                <li><a class="dropdown-item font-1" href="{{route('vendor.traffics.error-reports')}}"><span class="fal fa-bug font-1"></span> تقارير الأخطاء</a></li> 
                                @endcan
                                ...
                                <li><a class="dropdown-item font-1" href="{{route('agency-logout')}}" ><span class="fal fa-sign-out-alt font-1"></span> تسجيل خروج</a></li>
                        </ul>
