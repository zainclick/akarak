        ...
        <div class="col-12 px-0 pb-4 text-center justify-content-center align-items-center ">
            ...
            <img src="{{auth()->user()->getUserAvatar()}}" style="width: 80px;height: 80px;color: var(--background-1);border-radius: 50%" class="d-inline-block">
                ...
                <div class="col-12 px-0 mt-2 text-center" style="color: #232323;">
                    {{__('admin/menue_right.welcome')}} {{auth()->user()->name}}
                </div> 
            </div>
                ...
                <div class="col-12 px-3 aside-menu" style="height: calc(100vh - 260px);overflow: auto;">
                    ...
                    <a href="{{route('admin.roles.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            ...
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                {{__('admin/menue_right.prevelige')}}
                            </div> 
                        </div>
                    </a>
                    @endcan
                        ...
                        <div class="col-12 item px-0 d-flex row " >
                            <div class="col-12 d-flex px-0 item-container">
                                ...
                                <div style="width: calc(100% - 50px)" class="px-2 item-container-title has-sub-menu">
                                    {{__('admin/menue_right.agencies')}}
                                </div> 
                            </div>
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    @can('categories-read')
                                    <li><a href="{{route('admin.agencies.index')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.agencies_view')}}</a></li>
                                    <li><a href="{{route('admin.agencies.features')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.agencies_features')}}</a></li>

                                    @endcan
                                    @can('articles-read')
                                    <li><a href="{{route('admin.agents.index')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.agencies_agent')}}</a></li>
                                    <li><a href="{{route('admin.agents.features')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.agents_features')}}</a></li>
                    ...
                    <div class="col-12 px-0" style="cursor: pointer;">
                        <div class="col-12 item px-0 d-flex row " >
                            <div class="col-12 d-flex px-0 item-container">
                                ...
                                <div style="width: calc(100% - 50px)" class="px-2 item-container-title has-sub-menu">
                                    {{__('admin/menue_right.properties')}}
                                </div> 
                            </div>
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    @can('categories-read')
                                    <li><a href="{{route('admin.properties.index')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.properties_view')}}</a></li>
                                    @endcan
                                    @can('articles-read')
                    ...
                    @can('users-read')
                    <a href="{{route('admin.admins.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-users font-2"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                {{__('admin/menue_right.admins')}}
                            </div> 
                        </div>
                    </a>
                    @endcan
                    ...
                    @can('users-read')
                    <a href="{{route('admin.plans.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-users font-2"> </span> 
                            </div>
                    ...
                    <a href="{{route('admin.languages.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            ...
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                {{__('admin/menue_right.languages')}}
                            </div> 
                        </div>
                    </a>
                    @endcan                     
                    ...
                    <div class="col-12 px-0" style="cursor: pointer;">
                        <div class="col-12 item px-0 d-flex row " >
                            <div class="col-12 d-flex px-0 item-container">
                                ...
                                <div style="width: calc(100% - 50px)" class="px-2 item-container-title has-sub-menu">
                                    {{__('admin/menue_right.content')}}
                                </div> 
                            </div>
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    @can('categories-read')
                                    <li><a href="{{route('admin.categories.index')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.sections')}}</a></li>
                                    @endcan
                                    @can('articles-read')
                                    <li><a href="{{route('admin.articles.index')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.articals')}}</a></li>
                                    @endcan

                                    @can('comments-read')
                                    <li><a href="{{route('admin.article-comments.index')}}" style="font-size: 16px;"><span class="fal fa-comments px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.comments')}}
                                        @php
                                    ...
                                    <li><a href="{{route('admin.announcements.index')}}" style="font-size: 16px;"><span class="fal fa-bullhorn px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.ads')}}
                                    </a></li>
                                    @endcan
                                    @can('pages-read')
                                    <li><a href="{{route('admin.pages.index')}}" style="font-size: 16px;"><span class="fal fa-file-invoice px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.pages')}}
                                    </a></li>
                                    @endcan

                                    @can('menus-read')
                                    <li><a href="{{route('admin.menus.index')}}" style="font-size: 16px;"><span class="fal fa-list px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.menues')}}
                                    </a></li>
                                    @endcan
                                    @can('faqs-read')
                                    <li><a href="{{route('admin.faqs.index')}}" style="font-size: 16px;"><span class="fal fa-question px-2" style="width: 28px;font-size: 15px;"></span>  {{__('admin/menue_right.faqs')}}
                                    </a></li>
                                    @endcan
                                    @can('redirections-read')
                                    <li><a href="{{route('admin.redirections.index')}}" style="font-size: 16px;"><span class="fal fa-directions px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.redirections')}}
                                    </a></li>
                                    @endcan
                                    @can('tags-read')
                                    <li><a href="{{route('admin.tags.index')}}" style="font-size: 16px;"><span class="fal fa-tags px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.tags')}}
                                    </a></li>
                                    @endcan
                    ...
                    <a href="{{route('admin.contacts.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            ...
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                {{__('admin/menue_right.contact_request')}}
                            @php
                        ...
                        <div class="col-12 item px-0 d-flex row " >
                            ...
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    ...
                                    @can('plugins-read')
                                    <li><a href="{{route('admin.plugins.index')}}" style="font-size: 16px;"><span class="fal fa-box-open px-2" style="width: 28px;font-size: 15px;"></span> {{__('admin/menue_right.all_plugins')}}
