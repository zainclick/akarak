							...
							<div class="dashboard-navbar">
								...
								<div class="d-navigation">
									<ul>
										...
										<li><a href="{{route('agent-properties')}}"><i class="ti-layers"></i> <span>{{__('agencies/dashboard.properties')}} </span></a></li>
										<li><a href="{{route('agent-properties-create')}}"><i class="ti-pencil-alt"></i> <span>{{__('agencies/dashboard.new_property')}} </span></a></li>
