					...
					<nav id="navigation" class="navigation navigation-landscape">
						...
						<div class="nav-menus-wrapper" style="transition-property: none;"><span class="nav-menus-wrapper-close-button">✕</span>
							<ul class="nav-menu">
								...
								<li class="active"><a href="#">Home<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
								...
								<li class=""><a href="JavaScript:Void(0);">Listings<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu" style="right: auto; display: none;">
										<li><a href="JavaScript:Void(0);">List Layout<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
										...
										<li><a href="JavaScript:Void(0);">Grid Layout<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu" style="">
										...
										<li><a href="JavaScript:Void(0);">With Map Property<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu" style="">
								...
								<li class=""><a href="JavaScript:Void(0);">Features<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu" style="right: auto;">
										<li><a href="JavaScript:Void(0);">Single Property<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu" style="">
										...
										<li><a href="JavaScript:Void(0);">Agencies &amp; Agents<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu" style="">
										...
										<li><a href="JavaScript:Void(0);">My Account<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu" style="">
								...
								<li><a href="JavaScript:Void(0);">Pages<span class="submenu-indicator"></span><span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu" style="right: auto;">
									
										<li><a href="{{route('front-properties')}}">Properties</a></li> 
										<li><a href="{{route('front-pricing')}}">Pricing</a></li>                                    
										<li><a href="{{route('front-properties-show',1)}}">Show property</a></li>                                    
										<li><a href="{{route('front-agencies')}}">Agencies</a></li> 
										<li><a href="{{route('front-agencies-show',1)}}">Show agency</a></li>  
										<li><a href="404.html">Error Page</a></li>
										<li><a href="contact.html">Contacts</a></li>
									</ul>
								</li>
								
								<li class=""><a href="JavaScript:Void(0);" data-toggle="modal" data-target="#signup">Sign Up</a></li>
