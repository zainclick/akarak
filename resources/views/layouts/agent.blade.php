...
<head>
    ...
    @if(auth('agent')->check())
        ...
        $notifications=auth('agent')->user()->notifications()->orderBy('created_at','DESC')->limit(50)->get();
        $unreadNotifications=auth('agent')->user()->unreadNotifications()->count();
        @endphp
    @endif
...
<body style="background: #eef4f5" class="dash">
    ...
    <div class="col-12 d-flex">
        ...
        <div class="col-12 px-0 pb-4 text-center justify-content-center align-items-center ">
            ...
            <img src="{{auth('agent')->user()->getUserAvatar()}}" style="width: 80px;height: 80px;color: var(--background-1);border-radius: 50%" class="d-inline-block">
                </a>
                <div class="col-12 px-0 mt-2 text-center" style="color: #232323;">
                    {{__('agent/menue_right.welcome')}} <?php if(app()->getLocale() == 'ar'){echo auth('agent')->user()->name_ar;}else{echo auth('agent')->user()->name_en;} ?>
                </div> 
            </div>
                        ...
                        <div class="col-12 item px-0 d-flex row " >
                            ...
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    ...
                                    <li><a href="{{route('agent-properties')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.my_properties')}}</a></li>
                                    <li><a href="{{route('agent-properties-create')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.create_properties')}}</a></li>
                                    <li><a href="{{route('admin.agents.index')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.fav_properties')}}</a></li>
                                    <li><a href="{{route('admin.agents.index')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.pending_properties')}}</a></li>
                ...
                <div class="col-12 px-0 d-flex justify-content-end  " style="height: 60px;">
                    ...
                    <div class="col-12 px-0 d-flex justify-content-center align-items-center  dropdown"  style="width: 55px;height: 55px;" >
                        <div style="width: 55px;height: 55px;cursor: pointer;" data-bs-toggle="dropdown" aria-expanded="false" class="d-flex justify-content-center align-items-center cursor-pointer">
                            <img src="{{auth('agent')->user()->getUserAvatar()}}" style="padding: 10px;border-radius: 50%;width: 55px;height: 55px;">
                        </div>
