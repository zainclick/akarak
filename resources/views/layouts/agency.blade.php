...
<head>
    ...
    <link rel="stylesheet" href="/build/assets/dashboard-1fcbed15_{{app()->getLocale()}}.css" data-navigate-track="reload" /> 
    ...
    @if(auth('agency')->check())
        ...
        $notifications=auth('agency')->user()->notifications()->orderBy('created_at','DESC')->limit(50)->get();
        $unreadNotifications=auth('agency')->user()->unreadNotifications()->count();
        @endphp
    @endif
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/dropzone2.min.css">
</head>
...
<body style="background: #eef4f5" class="dash">
    ...
    <div class="col-12 d-flex">
        ...
        <div class="col-12 px-0 pb-4 text-center justify-content-center align-items-center ">
            ...
            <img src="{{auth('agency')->user()->main_image()}}" style="width: 200px;height: 80px;color: var(--background-1);" class="d-inline-block">
                </a>
                <div class="col-12 px-0 mt-2 text-center" style="color: #232323;">
                    {{__('agent/menue_right.welcome')}} <?php if(app()->getLocale() == 'ar'){echo auth('agency')->user()->name_ar;}else{echo auth('agency')->user()->name_en;} ?>
                </div> 
            </div>
            <div class="col-12 px-0">
                ...
                <div class="col-12 px-3 aside-menu" style="height: calc(100vh - 260px);overflow: auto;">
                    ...
                    <a href="{{route('agent.index')}}" class="col-12 px-0" >
                        ...
                        <div class="col-12 item px-0 d-flex row " >
                            <div class="col-12 d-flex px-0 item-container">
                                ...
                                <div style="width: calc(100% - 50px)" class="px-2 item-container-title has-sub-menu">
                                    {{__('agencies/menue_right.agents')}}
                                </div> 
                            </div>
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    
                                    <li><a href="{{route('agency-agents')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> {{__('agencies/menue_right.all_agents')}}</a></li>
                                    <li><a href="{{route('agency-agents-create')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agencies/menue_right.new_agent')}}</a></li>
                                    <li><a href="{{route('agency-agents-pending')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agencies/menue_right.pending_agent')}}</a></li>
                    ...
                    <div class="col-12 px-0" style="cursor: pointer;">
                        <div class="col-12 item px-0 d-flex row " >
                            <div class="col-12 d-flex px-0 item-container">
                                ...
                                <div style="width: calc(100% - 50px)" class="px-2 item-container-title has-sub-menu">
                                    {{__('agent/menue_right.properties')}}
                                </div> 
                            </div>
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    
                                    <li><a href="{{route('agency-properties')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.my_properties')}}</a></li>
                                    <li><a href="{{route('agency-properties-create')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.create_properties')}}</a></li>
                                    <li><a href="{{route('agency-properties-features')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.fav_properties')}}</a></li>
                                    <li><a href="{{route('agency-properties-pending')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.pending_properties')}}</a></li>
                    ...
                    <a href="{{route('agency-subscriptions')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-users font-2"> </span> 
                            </div>
                    ...
                    <a href="{{route('admin.citys.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-users font-2"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                {{__('agent/menue_right.citys')}}
                            </div> 
                        </div>
                    </a>
                    ...
                    <a href="{{route('admin.languages.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-users font-2"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                {{__('agent/menue_right.languages')}}
                            </div> 
                        </div>
                    </a>
                    ...
                    <a href="{{route('admin.titles.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-users font-2"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                {{__('agent/menue_right.titles')}}
                            </div> 
                        </div>
                    </a>
                    ...
                    <div class="col-12 px-0" style="cursor: pointer;">
                        <div class="col-12 item px-0 d-flex row " >
                            <div class="col-12 d-flex px-0 item-container">
                                ...
                                <div style="width: calc(100% - 50px)" class="px-2 item-container-title has-sub-menu">
                                    {{__('agent/menue_right.content')}}
                                </div> 
                            </div>
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    
                                    <li><a href="{{route('admin.categories.index')}}" style="font-size: 16px;"><span class="fal fa-tag px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.sections')}}</a></li>
                                    
                                    
                                    <li><a href="{{route('admin.articles.index')}}" style="font-size: 16px;"><span class="fal fa-book px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.articals')}}</a></li>
                                    

                                    
                                    <li><a href="{{route('admin.article-comments.index')}}" style="font-size: 16px;"><span class="fal fa-comments px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.comments')}}
                                        @php
                                    ...
                                    <li><a href="{{route('admin.announcements.index')}}" style="font-size: 16px;"><span class="fal fa-bullhorn px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.ads')}}
                                    </a></li>
                                    
                                    
                                    <li><a href="{{route('admin.pages.index')}}" style="font-size: 16px;"><span class="fal fa-file-invoice px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.pages')}}
                                    </a></li>
                                    

                                    
                                    <li><a href="{{route('admin.menus.index')}}" style="font-size: 16px;"><span class="fal fa-list px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.menues')}}
                                    </a></li>
                                    
                                    
                                    <li><a href="{{route('admin.faqs.index')}}" style="font-size: 16px;"><span class="fal fa-question px-2" style="width: 28px;font-size: 15px;"></span>  {{__('agent/menue_right.faqs')}}
                                    </a></li>
                                    
                                    
                                    <li><a href="{{route('admin.redirections.index')}}" style="font-size: 16px;"><span class="fal fa-directions px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.redirections')}}
                                    </a></li>
                                  
                                    <li><a href="{{route('admin.tags.index')}}" style="font-size: 16px;"><span class="fal fa-tags px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.tags')}}
                                    </a></li>
                    ...
                    <a href="{{route('admin.contacts.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            ...
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                {{__('agent/menue_right.contact_request')}}
                            @php
                    ...
                    <a href="{{route('agent.settings.index')}}" class="col-12 px-0" >
                        <div class="col-12 item-container px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-wrench font-2"> </span> 
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                               {{__('agent/menue_right.settings')}}
                            </div> 
                        </div>
                    </a> 
                        ...
                        <div class="col-12 item px-0 d-flex row " >
                            ...
                            <div class="col-12 px-0" >
                                <ul class="sub-item font-1" style="list-style:none;">
                                    ...
                                    <li><a href="{{route('admin.plugins.index')}}" style="font-size: 16px;"><span class="fal fa-box-open px-2" style="width: 28px;font-size: 15px;"></span> {{__('agent/menue_right.all_plugins')}}
                ...
                <div class="col-12 px-0 d-flex justify-content-end  " style="height: 60px;">
                    ...
                    <div class="col-12 px-0 d-flex justify-content-center align-items-center  dropdown"  style="width: 55px;height: 55px;" >
                        <div style="width: 55px;height: 55px;cursor: pointer;" data-bs-toggle="dropdown" aria-expanded="false" class="d-flex justify-content-center align-items-center cursor-pointer">
                            <img src="{{auth('agency')->user()->getUserAvatar()}}" style="padding: 10px;border-radius: 50%;width: 55px;height: 55px;">
                        </div>
