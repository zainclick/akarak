...
use App\Http\Controllers\Backend\BackendCitysController;
use App\Http\Controllers\Backend\BackendPlansController;
...
use App\Http\Controllers\Backend\BackendTitlesController;
...
use App\Http\Controllers\Backend\BackendAgenciesFeaturesController;
use App\Http\Controllers\Backend\BackendPropertiesFeaturesController;
...
Route::prefix('admin/dashboard')->middleware(['auth','ActiveAccount','verified'])->name('user.')->group(function () {
...
Route::prefix('admin')->middleware(['auth','ActiveAccount'])->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        //Agency routes
        Route::resource('agencies',BackendAgenciesController::class);
        Route::get('agencies-features',[BackendAgenciesFeaturesController::class,'index'])->name('agencies.features');
        Route::get('add-agency-features/{slug}',[BackendAgenciesController::class,'add_agency_features'])->name('add.agency.features');
        Route::get('remove-agency-features/{slug}',[BackendAgenciesController::class,'remove_agency_features'])->name('remove.agency.features');

        Route::resource('agents',BackendAgentsController::class);
        Route::get('agents-features',[BackendAgentsFeaturesController::class,'index'])->name('agents.features');


        Route::resource('properties',BackendPropertiesController::class);
        ...
        //Packages routes
        Route::resource('packages',BackendPackagesController::class);
        
        // Plans Routes
        Route::resource('plans',BackendPlansController::class);

        //Citys routes
        Route::resource('citys',BackendCitysController::class);

        //Languages routes
        Route::resource('languages',BackendLanguagesController::class);

        //Jobs_title routes
        Route::resource('titles',BackendTitlesController::class);
        ...
        Route::resource('admins',BackendUserController::class);
        Route::resource('users',BackendFrontUsersController::class);
...
Route::get('add-agent-features/{slug}',[BackendAgentsController::class,'add_agent_features'])->middleware(['auth:agency,web'])->name('add.agent.features');
Route::get('remove-agent-features/{slug}',[BackendAgentsController::class,'remove_agent_features'])->middleware(['auth:agency,web'])->name('remove.agent.features');

Route::get('add-super-agent/{slug}',[BackendAgentsController::class,'add_super_agent'])->middleware(['auth:agency,web'])->name('add.super.agent');
Route::get('remove-super-agent/{slug}',[BackendAgentsController::class,'remove_super_agent'])->middleware(['auth:agency,web'])->name('remove.super.agent');

Route::get('add-property-features/{slug}',[BackendPropertiesController::class,'add_property_features'])->middleware(['auth:agency,web'])->name('add.property.features');
Route::get('remove-property-features/{slug}',[BackendPropertiesController::class,'remove_property_features'])->middleware(['auth:agency,web'])->name('remove.property.features');
...
route::get('zain',function(){
    ...
    return 'welcome zain from admin route';
});
