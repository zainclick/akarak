...
class AgencyCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.categories.index',compact('categories'));
    }
    ...
    {
        return view('vend.categories.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.categories.index');
    }
    ...
    {   
        return view('vend.categories.edit',compact('category'));
    }
