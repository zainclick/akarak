...
class AgencyPermissionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.permissions.index',compact('permissions'));
    }
    ...
    public function create()
    {
        ...
        return view('vend.permissions.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.permissions.index');
    }
    ...
    public function edit(Request $request,Permission $permission)
    {
        ...
        return view('vend.permissions.edit',compact('permission'));
    }
