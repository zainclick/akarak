...
class AgencyArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.articles.index',compact('articles'));
    }
    ...
    public function create()
    {
        ...
        return view('vend.articles.create',compact('categories','tags'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.articles.index');
    }
    ...
    public function edit(Article $article)
    {
        $tags = Tag::get();
        $categories= Category::orderBy('id','DESC')->get();
        return view('vend.articles.edit',compact('article','categories','tags'));
    }
