...
class AgencyMenuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.menus.index',compact('menus'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.menus.index');
    }
    ...
    public function edit(Menu $menu)
    {
        ...
        return view('vend.menus.edit',compact('menu'));
    }
