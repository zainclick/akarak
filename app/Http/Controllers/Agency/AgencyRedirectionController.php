...
class AgencyRedirectionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('agencies.redirections.index',compact('redirections'));
    }
    ...
    public function create()
    {
        ...
        return view('agencies.redirections.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.redirections.index');
    }
    ...
    public function edit(Redirection $redirection)
    {
        ...
        return view('agencies.redirections.edit',compact('redirection'));
    }
