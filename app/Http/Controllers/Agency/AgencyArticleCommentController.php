...
class AgencyArticleCommentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.comments.index',compact('comments'));
    ...
    {
        return view('vend.comments.edit',compact('article_comment'));
    }
    ...
    public function update(Request $request, ArticleComment $article_comment)
    {
        ...
        return redirect()->route('agency.article-comments.index',['article_id'=>$article_comment->article_id]);
    }
