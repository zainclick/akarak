...
class AgencyContactReplyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.contacts.replies.index',compact('contact'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $request->validate(['contact_id'=>"required|exists:contacts,id"]);
        $contact = \App\Models\Contact::where('id',$request->id)->with(['replies'])->firstOrFail();
        return view('vend.contacts.replies.create',compact('contact'));
