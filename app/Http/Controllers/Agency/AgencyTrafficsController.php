...
class AgencyTrafficsController extends Controller
{
    ...
    public function links(Request $request){
      ...
      return view('agencies.traffics.links',compact('links'));
    }
    public function details(Request $request){
      ...
      return view('agencies.traffics.logs',compact('logs'));
    }
    public function index(Request $request){
      if(!auth()->user()->can('traffics-read'))abort(403);
        ...
        return view('agencies.traffics.index',compact('traffics'));
    }
    ...
    public function error_reports(Request $request){
      if(!auth()->user()->can('error-reports-read'))abort(403);
        ...
        return view('agencies.traffics.error-reports',compact('reports'));
    }
