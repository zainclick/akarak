...
class AgencyFaqController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.faqs.index',compact('faqs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.faqs.index');
    }
    ...
    {
        return view('vend.faqs.edit',compact('faq'));
    }
