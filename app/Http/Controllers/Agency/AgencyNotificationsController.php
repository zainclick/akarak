...
class AgencyNotificationsController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('vend.notifications.index',compact('notifications'));
    }
    ...
    public function create(Request $request){
        ...
        return view('vend.notifications.create');
    }
    public function store(Request $request){
        ...
        (new \MainHelper)->notify_user([
            ...
            'action_url'=>route('agency.contacts.show',$contact)
        ]);
        toastr()->success('تم إرسال التنبيه بنجاح');
        return redirect()->route('agency.notifications.index',['user_id'=>$request->user_id]);
