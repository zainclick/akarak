...
class AgencyPluginController extends Controller
{
    ...
    {
        return view('vend.plugins.index');
    }
    public function create(Request $request)
    {
        return view('vend.plugins.create');
    }
    public function store(Request $request)
    {
        ...
        if ($res === TRUE) {
          ...
          return redirect()->route('agency.plugins.index');
        } else {
