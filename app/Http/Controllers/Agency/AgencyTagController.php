...
class AgencyTagController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('agencies.tags.index',compact('tags'));
    }
    ...
    {
        return view('agencies.tags.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.tags.index');
    }
    ...
    {
        return view('agencies.tags.edit',compact('tag'));
    }
