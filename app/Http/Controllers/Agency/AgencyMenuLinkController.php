...
class AgencyMenuLinkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.menu-links.index',compact('menuLinks'));
    }
    /**
    ...
    public function create(Request $request)
    {
        ...
        return view('vend.menu-links.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.menu-links.index',['menu_id'=>$request->menu_id]);
    }
    ...
    public function edit(MenuLink $menuLink)
    {
        ...
        return view('vend.menu-links.edit',compact('menuLink'));
    }
    ...
    {  
        ...
        $menuLink->delete();
        toastr()->success('تمت العملية بنجاح');
        return redirect()->route('agency.menu-links.index',['menu_id'=>$menu_id]);
    }
