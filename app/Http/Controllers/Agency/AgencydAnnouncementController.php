...
class AgencydAnnouncementController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vend.announcements.index',compact('announcements'));
    }
    ...
    {
        return view('vend.announcements.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agency.announcements.index');
    }
    ...
    {
        return view('vend.announcements.edit',compact('announcement'));
    }
